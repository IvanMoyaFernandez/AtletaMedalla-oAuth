...
public class AtletaResourceIntTest {
    ...
    public void createAtleta() throws Exception {
        ...
        assertThat(testAtleta.getApellidos()).isEqualTo(DEFAULT_APELLIDOS);
    ...
    public void updateAtleta() throws Exception {
        ...
        assertThat(testAtleta.getApellidos()).isEqualTo(UPDATED_APELLIDOS);
